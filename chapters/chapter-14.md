...
3.  **She Calms the Hijacked Musician (Chapter 4):** She sees Leo's bouncing leg and wide eyes. *"The old me would have jumped in with a solution,"* she thinks. *"Breathe. Connect first."* She turns to him. "Leo, you're closest to the supplier integration. This must feel incredibly stressful. What's the hardest part of this for you right now?" Leo, feeling seen, explains the technical tangle. Maria uses **The Playback**: "Okay, so what I'm hearing is that the immediate problem isn't just the delay, it's the fear that their failure could corrupt our existing database. Did I get that right?" The validation calms Leo's amygdala. He nods, relieved.
